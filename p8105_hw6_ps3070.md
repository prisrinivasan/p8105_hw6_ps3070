...
The 95% confidence interval for the log data is (1.94, 2.08). The 95% confidence interval for the *r*<sup>2</sup> is (1.94, 2.08). Since the null value of zero is not within either CI, we are 95% confident that the true values for both lie in these ranges based on this sample.

Other information:

Log Median: 2.01

*r*<sup>2</sup> Median: 0.91
